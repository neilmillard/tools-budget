  ...
  return (
    <div className="w-[83%] mx-auto p-6 bg-white rounded-2xl shadow-md">
      ...
      <div className="p-6">
        ...
        <p>You want to live below your income and invest the rest. If you have loans or credit cards, pay these off before investing.</p>
        <FinancialSteps/>
        <p className="pt-6"><Link href={'/budget/'}><b>Budget Planner</b></Link> enables you to fill in the form similar to a bank loan.
